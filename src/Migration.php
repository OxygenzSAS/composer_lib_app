...
class Migration
{
    ...
    public function upgrade(){
        ...
        foreach ($files as $file){
            ...
            /** @var \OxygenzSAS\Interfaces\MigrationInterface $migration_instance */
            $migration_instance = require_once $this->path_folder_migration.'/'.$file;
            if(is_object($migration_instance) === false){
                throw new \Exception('Migration file '.$this->path_folder_migration.'/'.$file.' should return instance of \OxygenzSAS\Interfaces\MigrationInterface ');
            }
    ...
    public function downgrade(){
        ...
        if(is_object($migration_instance) === false){
            throw new \Exception('Migration file '.$this->path_folder_migration.'/'.$rs[0]['filename'].' should return instance of \OxygenzSAS\Interfaces\MigrationInterface ');
        }
